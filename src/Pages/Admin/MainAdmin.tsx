...
navigate('../../Login')
  ...
  const drawer = (
    <div><h2  className='text-center fw-bolder m-3' >ADMIN</h2>
...
<Route path='intList' element={<InstList/>} />
<Route path='instDetails/:id' element={<InstDetails/>} />
